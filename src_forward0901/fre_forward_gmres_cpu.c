   ...
   dblock=(int)(nfft/(npros));
    ...
    switch(op_fdmodel)
    {
        ...
        for(ifreq=f_beg;ifreq<f_end;++ifreq)
        {
            ...
            sprintf(optname,"./Data/frequency_slice_%d.bin",iiifreq);
            ...
            sprintf(optname,"./Data/complex_r_%d.bin",iiifreq);
            optfp=fopen(optname,"w");
            ...
            sprintf(optname,"./Data/complex_r2D_%d.bin",iiifreq);
            optfp=fopen(optname,"w");
            ...
            {
                sprintf(optname,"./Data/norm2shiftlaplace_res%d.bin",iiifreq);
                optfp=fopen(optname,"w");
            ...
            {
                sprintf(optname,"./Data/norm2_res%d.bin",iiifreq);
                optfp=fopen(optname,"w");
                fwrite(norm2_res,sizeof(float),(nter_max+1),optfp);
                fclose(optfp);
            }
