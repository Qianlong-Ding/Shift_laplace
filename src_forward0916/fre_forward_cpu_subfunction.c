    ...
    char *frslicepath,FILE* logfp)
{
    ...
    //         mkl_zcsrgemv("N",&RankIlevel[0],h_Val[0],h_Row[0],h_Col[0],h_x,h_b);

    // //         omp_mklgemv( mkl_parallel,h_Val[0],h_Row[0],h_Col[0],
    // // h_x,h_b,RankIlevel[0]);
    //     }
    ...
    //     matrix_sort(h_ValA,h_RowA,h_ColA,RankIlevel[0],mkl_parallel);
    //     solve_matrix( mkl_parallel,h_ValA, h_RowA, h_ColA,
