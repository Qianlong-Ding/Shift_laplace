    ...
    MKL_INT nnz,MKL_Complex16 *h_B,MKL_Complex16 *h_X)
{
    ...
    // warn("222 h_RowA[0][0]=%d  h_RowA[0][1]=%d",h_RowA[0],h_RowA[nnz]);

    h_Val=(MKL_Complex16 *)mkl_malloc(sizeof(MKL_Complex16)*(h_RowA[nnz]-h_RowA[0]),64);
    ...
    // pardiso_64(pt,&maxfct,&mnum,&mtype,&phase,&n,h_Val,h_Row,h_Col,&idum,&nrhs,iparm,&msglvl,&ddum,&ddum,&error);
